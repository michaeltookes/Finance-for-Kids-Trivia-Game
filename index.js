...
function nextQuestion() {
    ...
    for (var x = 0; x < questions[currentQuestion].choice.length; x++) {
        // ternary operator (true/false)
        var answerFunction = (questions[currentQuestion].choice[x] == questions[currentQuestion].answer)?"correct()":"incorrect()";
        var html = `<button onclick="${answerFunction}"> ${questions[currentQuestion].choice[x]}</button>`
        quizContent += html

        // var answerFunction;
        // if (questions[currentQuestion].choice[x] == questions[currentQuestion].answer) {
